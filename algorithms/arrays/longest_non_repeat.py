...
#get call by main method
if __name__ == '__main__':
    print(longest_non_repeat_v1('abcabcbb'))
    print(longest_non_repeat_v2('abcabcbb'))
    print(get_longest_non_repeat_v1('abcabcbb'))
    print(get_longest_non_repeat_v2('abcabcbb'))
    print(get_longest_non_repeat_v3('abcabcbb'))