...
if __name__ == '__main__':
    print(insert_one_bit(10101, 1, 2))
    print(insert_one_bit(10101, 0, 2))
    print(insert_one_bit(10101, 1, 5))
    print(insert_one_bit(10101, 1, 0))
    print(insert_mult_bits(101, 7, 3, 1))
    print(insert_mult_bits(101, 7, 3, 0))
    print(insert_mult_bits(101, 7, 3, 3))