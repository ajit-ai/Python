...
if __name__ == '__main__':
    print(has_alternative_bit(5))
    print(has_alternative_bit(7))
    print(has_alternative_bit(11))
    print(has_alternative_bit(10))
    print(has_alternative_bit_fast(5))
    print(has_alternative_bit_fast(7))
    print(has_alternative_bit_fast(11))
    print(has_alternative_bit_fast(10))