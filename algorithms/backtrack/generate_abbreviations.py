...
# find or generate abbrevations
def find_or_generate_abbreviations(word, dictionary):
    if word in dictionary:
        return dictionary[word]
    else:
        return generate_abbreviations(word)
...
if __name__ == '__main__':
    ...
    print(find_or_generate_abbreviations('word', {}))