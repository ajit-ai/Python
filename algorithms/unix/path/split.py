...
if __name__ == '__main__':
    print(split("https://algorithms/unix/test.py"))
    print(split("algorithms/unix/test.py"))
    print(os.path.split("https://algorithms/unix/test.py"))
    print(os.path.split("algorithms/unix/test.py"))