...
#find the methods in the given string


if __name__ == '__main__':
    print(match_symbol(["Amazon", "Microsoft", "Google"], ["i", "Am", "cro", "Na", "le", "abc"])) 
    
# use bracket methods to find the methods

if __name__ == '__main__':
    print(bracket(["Amazon", "Microsoft", "Google"], ["i", "Am", "cro", "Na", "le", "abc"]))
    
    
# use match_symbol_1 methods to find the methods

if __name__ == '__main__':
    print(match_symbol_1(["Amazon", "Microsoft", "Google"], ["i", "Am", "cro", "Na", "le", "abc"]))
